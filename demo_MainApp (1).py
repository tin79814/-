...
class MainApp(QMainWindow, Ui_MainWindow):
    ...
    def fig1(self):
        ...
        def draw_three_ray(r):
            pencolor = ["cyan", "green", "orange"]
            y0 = [50,0,-30]
            if r > 0:#凸面介面
                x0 = [-r-150,-r-100,-r-50]#入射點
            else:#凹面介面
                x0 = [r-150,r-r,r+250]#入射點
            for i in range(3):
                for j in range(3):
                    draw_a_ray(t,x0[i],y0[i],theta0[j],pencolor[i])  
        r = 200
        ...
        #測試
        #draw_a_ray(t,-350,50,theta0,"cyan")
        #draw_a_ray(t,-350,50,theta0-5,"cyan")    
        #draw_a_ray(t,-350,50,theta0+5,"cyan")
        
        #draw_a_ray(t,0,0,theta0,"green")
        #draw_a_ray(t,0,0,theta0-5,"green")    
        #draw_a_ray(t,0,0,theta0+5,"green")
        #    
        #draw_a_ray(t,50,-30,theta0,"orange")
        #draw_a_ray(t,50,-30,theta0-5,"orange")    
        #draw_a_ray(t,50,-30,theta0+5,"orange")
        ...
        # 設定橫向繪圖區域座標
        mpl.ax.set_xlim(0, 100)
        
        # 設定縱向繪圖區域座標
        mpl.ax.set_ylim(0, 100)
